...
namespace GlobalPay\Module\Model\Ui;

use Magento\Checkout\Model\ConfigProviderInterface;
use Magento\Payment\Helper\Data as PaymentHelper;
use GlobalPay\Module\Model\Payment;
...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    /**
     * @var \GlobalPay\Module\Model\Payment
     */
    protected $payment;
     ...
     * @param GlobalPay\Module\\ModelPayment $payment
    ...
    /**
     * Magic method
     * @return object \GlobalPay\Module\Model\Ui\ConfigProvider
     */
        ...
        foreach ($this->methodCodes as $code) {
            if ($this->methods[$code]->isAvailable()) {
                ...
                if (empty($clientCredentials)) {
                    throw new MagentoValidatorException(__("Missing GlobalPay Redeban settings."));
                }

                $config['payment']['globalpay']['app_code'] = $clientCredentials['code'];
                $config['payment']['globalpay']['app_key'] = $clientCredentials['api_key'];
                $config['payment']['globalpay']['env'] = $this->payment->getClientEnvironment();
                $config['payment']['globalpay']['is_active'] = $this->methods[$code]->isAvailable();
