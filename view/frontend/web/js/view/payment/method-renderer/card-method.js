...
define(
    [
        ...
        'https://cdn.globalpay.com.co/ccapi/plugin/payment_magento_2.0.1.min.js'
    ],
    function (Component, $, quote, customer, validator, fullScreenLoader) {
        ...
        return Component.extend({
            defaults: {
                template: 'GlobalPay_Module/payment/cc-form'
            },

            getCode: function () {
                return 'globalpay_module';
            },
            ...
            isActive: function () {
                return window.checkoutConfig.payment.globalpay.is_active;
            },
            ...
            tokenize: function () {
                ...
                let settings = window.checkoutConfig.payment.globalpay;
