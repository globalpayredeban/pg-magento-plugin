...
use GlobalPay\Module\Api\PaymentNotificationInterface;
        ...
        if ($lastError !== JSON_ERROR_NONE) {
            ...
            if (empty($orderId)) {
                ...
                if (!in_array($transactionStatus, $successValues) || $statusDetail != 3) {
                    ...
                    $orderComment = "<strong>[GLOBALPAY]</strong>:Main Status: {$transactionStatus}, Status detail: {$statusDetail}, Additional comment: {$message}.";
